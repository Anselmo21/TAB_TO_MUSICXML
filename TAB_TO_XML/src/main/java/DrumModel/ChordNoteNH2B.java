...
@JsonPropertyOrder({"chord", "unpitch", "duration", "instrument", "voice", "type", "stem", "notehead", "beam1", "beam2"})
public class ChordNoteNH2B extends Note{
	...
	public ChordNoteNH2B() {}
	public ChordNoteNH2B(Unpitched pitch, String duration, String voice, String stem, String type, Instrument instrument, String notehead, String beam1, String location1, String beam2, String location2) {
